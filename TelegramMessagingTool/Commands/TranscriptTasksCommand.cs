...
public sealed class TranscriptTasksCommand : IBotCommand
{
    ...
    public string Name => "/transcripttasks";

    public string Description => "Draft a task list and suggested /plan command from a saved transcript document.";
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return new CommandResult(true, "Usage: /transcripttasks <transcript-file-id>");
        }
        ...
        {
            return new CommandResult(true, $"File #{file.Id} is not a saved transcript document. Use /transcribe <audio-id> first, then run /transcripttasks <transcript-file-id>.");
        }
