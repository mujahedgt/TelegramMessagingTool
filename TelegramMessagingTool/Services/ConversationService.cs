...
- Users can manage the bot with these Available Telegram commands: /help, /status, /reset, /remember <fact>, /memory, /forget <id>, /files, /readfile <id>, /createfile <filename> <content>, /indexfile <id>, /indexdocs, /docchunks <id>, /askfile <id> <question>, /askdocs <question>, /tools, /pending, /approve <id>, /deny <id>, /plan <goal>, /tasks, /task <id>, /done <task-id> [step-number], and /cancel <task-id>.
