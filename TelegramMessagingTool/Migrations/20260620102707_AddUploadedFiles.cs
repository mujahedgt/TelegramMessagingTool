        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbsolutePath = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UploadedFiles_Users_ConnectedUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UploadedFiles_ChatId",
                table: "UploadedFiles",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadedFiles_ConnectedUserId",
                table: "UploadedFiles",
