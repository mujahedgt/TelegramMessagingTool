...
$envNames = @('TELEGRAM_BOT_TOKEN','ADMIN_CHAT_ID','ALLOWED_CHAT_IDS','ALLOW_PUBLIC_ACCESS','OLLAMA_URL','OLLAMA_MODEL','OLLAMA_MODEL_CHAT','OLLAMA_MODEL_PLAN','OLLAMA_MODEL_DOC_QA','OLLAMA_MODEL_SUMMARY','OLLAMA_MODEL_TOOL_FINAL','OLLAMA_MODEL_IMAGE','OLLAMA_MODEL_VOICE','IMAGE_DESCRIPTION_PROMPT','ENABLE_IMAGE_OCR','IMAGE_OCR_COMMAND','IMAGE_OCR_ARGUMENTS','IMAGE_OCR_TIMEOUT_SECONDS','OLLAMA_EMBEDDING_URL','OLLAMA_EMBEDDING_MODEL','ENABLE_DOCUMENT_EMBEDDINGS','ENABLE_ONLINE_SEARCH','SEARCH_ROUTING_MODE','ENABLE_IMAGE_VISION','ENABLE_AUDIO_TRANSCRIPTION','AUDIO_TRANSCRIPTION_COMMAND','AUDIO_TRANSCRIPTION_ARGUMENTS','AUDIO_TRANSCRIPTION_TIMEOUT_SECONDS','ENABLE_TEXT_TO_SPEECH','TEXT_TO_SPEECH_COMMAND','TEXT_TO_SPEECH_ARGUMENTS','TEXT_TO_SPEECH_TIMEOUT_SECONDS','TEXT_TO_SPEECH_OUTPUT_EXTENSION','ENABLE_TELEGRAM_TYPING_INDICATOR','ENABLE_STREAMING_RESPONSES','ENABLE_SAFE_COMMAND_TOOLS','SAFE_COMMAND_PROJECT_ROOT','ENABLE_REPO_WRITE_TOOLS','ENABLE_PLUGINS','PLUGIN_DIRECTORY','ENABLE_GITHUB_TOOLS','ENABLE_GITHUB_WRITE_TOOLS','GITHUB_TOKEN','GITHUB_DEFAULT_OWNER','GITHUB_DEFAULT_REPO','GITHUB_ALLOWED_REPOS','TELEGRAM_DB_CONNECTION','APPLY_MIGRATIONS','LOG_MESSAGE_CONTENT','CONVERSATION_MAX_HISTORY')
