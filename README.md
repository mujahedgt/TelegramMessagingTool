...
- File commands: `/files`, `/images`, `/describeimage <id>`, `/voicefiles`, `/readfile <id>`, `/createfile <filename> <content>`, admin-only local import via `/importfiles` and `/importfile <filename>`, and admin-approved `/deletefile <id>`
