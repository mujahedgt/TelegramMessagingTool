...
public static class CommandTests
{
    public static void RunCommandRouterFactoryTests(BotSettings settings)
    {
        ...
        AssertEqual(
            "/help,/systeminfo,/diskstatus,/processes,/status,/health,/selfupdate,/errors,/riskconfig,/reset,/remember,/memory,/forget,/files,/images,/describeimage,/voicefiles,/transcribe,/transcriptinsights,/transcripttasks,/speaktext,/sendaudio,/exportchat,/exportdata,/readfile,/createfile,/importfiles,/importfile,/deletefile,/indexfile,/indexdocs,/docchunks,/askfile,/askdocs,/summarizefile,/summarizedocs,/embedfile,/embeddocs,/reembeddocs,/vectorstatus,/vectorsync,/vectorclear,/vectorrepair,/tools,/harnesses,/plugins,/killprocess,/action,/actions,/pending,/approve,/deny,/plan,/tasks,/task,/schedule,/schedulelist,/unschedule,/done,/cancel",
            commandNames,
